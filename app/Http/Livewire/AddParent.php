...
{
    use WithFileUploads;
    public $successMessage = '',$catchError , $photos = [];
    public $currentStep = 1, $updateMode=false , $show_parents=true,$Parent_id,
    ...
    public function showParentTable()
    {
...
// ************************* store attachments ********************************
    ...
    {
        $parent = My_Parent::findOrFail($id)->first();
        $parent->delete();

        return redirect()->to(App::getLocale() . '/add_parent');
