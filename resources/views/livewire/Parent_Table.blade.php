...
<?php
   if(DB::table('my__parents')->where('deleted_at' , NULL)->count()>0){
?>         
<!-- delete_modal_parentInfo -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-sm" wire:click="delete({{ $my_parent->id }})" title="delete">
