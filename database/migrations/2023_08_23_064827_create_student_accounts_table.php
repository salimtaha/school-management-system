...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('student_accounts', function (Blueprint $table) {
            ...
            $table->foreignId('receipt_id')->nullable()->references('id')->on('receipt_students')->onDelete('cascade');            $table->foreignId('student_id')->references('id')->on('students')->onDelete('cascade');
